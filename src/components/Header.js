              ...
              <div className="inner">
                <div className="site-header-inside">
                  <div className="site-branding">
                    ...
                    <h1 className={classNames('site-title', {'screen-reader-text': _.get(this.props, 'pageContext.site.siteMetadata.header.logo_img', null)})}><Link to={withPrefix('/')} style={background-image:}></Link></h1>
                    ) : 
